...
pub fn run(self: *@This(), params: main.callbacks.CallbackList.BlockTouchCallback.Params) main.callbacks.Result {
	std.debug.assert(params.id == main.game.Player.id); // TODO: Implement on the server side
