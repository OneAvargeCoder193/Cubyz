...
const ClientBlockCallback = main.callbacks.CallbackList.ClientBlockCallback;
const ServerBlockCallback = main.callbacks.CallbackList.ServerBlockCallback;
const BlockTouchCallback = main.callbacks.CallbackList.BlockTouchCallback;
...
pub fn parseBlockWasm(_: *main.wasm.WasmInstance, id: []const u8) u32 {
